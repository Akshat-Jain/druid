...
public class TestDataBuilder
{
  ...
  public static void attachIndexesForBenchmarkDatasource(SpecificSegmentsQuerySegmentWalker segmentWalker, File tmpDir)
  {
  ...
  public static QueryableIndex getQueryableIndexForBenchmarkDatasource()
  {
    ...
    final SegmentGenerator segmentGenerator = new SegmentGenerator();
