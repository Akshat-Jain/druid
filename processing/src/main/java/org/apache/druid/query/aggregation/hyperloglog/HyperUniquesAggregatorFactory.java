...
public class HyperUniquesAggregatorFactory extends AggregatorFactory
{
  ...
  public Aggregator factorize(ColumnSelectorFactory metricFactory)
  {
    ...
    // Improve this error message in all 3 factorize methods. This is the native layer improvement.
  ...
  public VectorAggregator factorizeVector(final VectorColumnSelectorFactory selectorFactory)
  {
    ...
    if (!Objects.equals(capabilities.toColumnType().getComplexTypeName(), TYPE.getComplexTypeName())
      ...
      throw new UnsupportedOperationException("Using aggregation type " + getIntermediateType().getComplexTypeName() + " is not supported for " + capabilities.getType() + "<" + capabilities.getComplexTypeName() + "> column. Use a different aggregator type and run the query again.");
    }
